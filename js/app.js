...
function buildDefaults(){
  const meta={
    a:{name:'Fiesta',bg:'#f7e01e',accent:'#2fa39a',accent2:'#f4d21e',frame:'#d9b44a',font:"'Baloo 2', system-ui, sans-serif",mode:'alt',alt:['#5bb7ad','#f6e34f']},
    b:{name:'Neón',bg:'#0b0e22',accent:'#00e5ff',accent2:'#ff2bd6',frame:'#2fd8ff',font:"'Orbitron', sans-serif",mode:'alt',alt:['#141a52','#00d8ff']},
    c:{name:'Oro',bg:'#12160f',accent:'#c9a24b',accent2:'#e6c778',frame:'#caa64f',font:"'Playfair Display', serif",mode:'alt',alt:['#20261c','#c9a24b']}
  };
  const templates={};
  ['a','b','c'].forEach(id=>{
...
function showIntro(){
  ...
  document.getElementById('introTitle').textContent=(t.introTitle||t.headerText||'').trim();
